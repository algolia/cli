...
By default, Algolia treats singular and plural forms of a word, and single-word synonyms, as exact matches when searching.
...
See: https://www.algolia.com/doc/api-reference/api-parameters/ignorePlurals`))
	...
	cmd.Flags().Var(insideBoundingBox, "insideBoundingBox", heredoc.Doc(`Coordinates for a rectangular area in which to search.
